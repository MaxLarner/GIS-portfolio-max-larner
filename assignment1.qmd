...
- [Full write-up (PDF)](writeups/assignment1-writeup.pdf)  
- <a href="https://github.com/MaxLarner/gis-portfolio-max-larner/blob/main/Code/assignment1.py" target="_blank">Python source code on GitHub</a>
